...
import com.google.firebase.database.FirebaseDatabase;
    ...
    public class Monday extends AppCompatActivity {
        ...
        public void onStart(){
            ...
            FirebaseRecyclerAdapter<ModelClass, ng.com.androidlife.bellokanoex.Monday.WeeklyViewHolder>
                    firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ModelClass, ng.com.androidlife.bellokanoex.Monday.WeeklyViewHolder>(
                    ModelClass.class,
                    R.layout.weeklyfx,
                    ng.com.androidlife.bellokanoex.Monday.WeeklyViewHolder.class,
                    myRef){
                @Override
                protected void populateViewHolder(ng.com.androidlife.bellokanoex.Monday.WeeklyViewHolder viewHolder, ModelClass model, int position) {
